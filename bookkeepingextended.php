...
class nz_co_fuzion_bookkeepingextended extends CRM_Report_Form {
    ...
    $this->_from = "
        FROM  civicrm_contact      {$this->_aliases['civicrm_contact']} {$this->_aclFrom}
              ...
              LEFT JOIN civicrm_financial_trxn {$this->_aliases['civicrm_financial_trxn']}
                        ON ( {$this->_aliases['civicrm_contribution']}.trxn_id = {$this->_aliases['civicrm_financial_trxn']}.trxn_id )";
  }
